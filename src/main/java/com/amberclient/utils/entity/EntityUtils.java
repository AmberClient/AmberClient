package com.amberclient.utils.entity;

import it.unimi.dsi.fastutil.longs.Long2ObjectMap;
import it.unimi.dsi.fastutil.longs.LongBidirectionalIterator;
import it.unimi.dsi.fastutil.longs.LongSortedSet;
import com.amberclient.mixins.accessors.EntityTrackingSectionAccessor;
import com.amberclient.mixins.accessors.SectionedEntityCacheAccessor;
import com.amberclient.mixins.accessors.SimpleEntityLookupAccessor;
import com.amberclient.mixins.accessors.WorldAccessor;
import com.amberclient.utils.player.PlayerUtils;
...
public class EntityUtils {
    ...
    public static boolean isAttackable(EntityType<?> type) {
        return type != EntityType.AREA_EFFECT_CLOUD && type != EntityType.ARROW && type != EntityType.FALLING_BLOCK &&
                type != EntityType.FIREWORK_ROCKET && type != EntityType.ITEM && type != EntityType.LLAMA_SPIT &&
                type != EntityType.SPECTRAL_ARROW && type != EntityType.ENDER_PEARL && type != EntityType.EXPERIENCE_BOTTLE &&
                type != EntityType.POTION && type != EntityType.TRIDENT && type != EntityType.LIGHTNING_BOLT &&
                type != EntityType.FISHING_BOBBER && type != EntityType.EXPERIENCE_ORB && type != EntityType.EGG;
    }
